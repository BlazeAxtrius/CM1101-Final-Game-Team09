room_reception = {
    "state_1": "The ceiling has a very darkish shade to it, "
               "\nseemingly because of the moisture."
               "\nWhen you look at the walls you can see water running down them."
               "\nThe place looks like it will fall apart any moment!",
    "state_2": "You are not here.",
    "state_3": "As you return to the Reception you see that the ceiling,"
